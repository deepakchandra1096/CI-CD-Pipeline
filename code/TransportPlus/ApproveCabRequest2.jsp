...
<%
	...
	try{
			...
			String Query = "Update cabrequest SET Status='"+Status+"' where RequestID in ("+pStr+")";
			System.out.println(Query);
			int result = stmt.executeUpdate(Query);
			System.out.println(result);
			if(result>0)	{
				%><h3 align=center>Request <%=Status%> sucessfully</h3>
				<center>
				<A href="ApproveCabRequests0.jsp"> Back</A>
				</center>
				<%
			}
			else{
