...
Host - 5.0.45-community-nt : Database - transport
*********************************************************************
...
insert  into `busrequest`(`RequestID`,`EmpNo`,`RouteCode`,`CategoryCode`,`Location`,`Address`,`StartDate`,`Status`,`PickupPoint`,`ActiveStatus`) values ('RB1','345435','B','A','fhfg','fghgfhf,dgdf','2007-10-10','Approved','bbbb',0),('RB10','777','C','MediumDistance','Hyderabad','SRNagar','2008-02-01','Approved','SRNagar',1),('RB11','1','C','LongDistance','qqq','qqq','2008-04-30','Approved','Patnycenter',1),('RB12','1','C','MediumDistance','asd','ads','2008-04-23','Open','SRNagar',1),('RB13','2','C','LongDistance','weqwe','sasd','2008-04-10','Open','Patnycenter',1),('RB2','2343','A',NULL,'hyderabad','dfgfdg,nbmvbnsd','2000-01-20','Approved','Mehadipatnam',0),('RB3','657657','B','A','hyderabad','fghfg,werwer','2000-01-01','Approved','Patny',1),('RB4','43543','A',NULL,'hyderabad','sdjfkjdsf,hysdfsdfkj','2000-01-01','Cancel','Gachibowly',0),('RB5','455','B',NULL,'ssdfd','dfgdfg,dfgdfg','2007-10-03','Approved','bbbb',1),('RB6','324324','B','A','gdfg','dfgdfg,dfgdfg','2007-10-03','Approved','bbbb',1),('RB7','45435','A',NULL,'dfgdfg','dfgfdgfd','2000-01-01','Cancel','ksdfh',0),('RB8','2222','B','ShortDistance','www','wwww','2000-01-04','Approved','bbbb',1),('RB9','333','A','LongDistance','hyderabad','asdf','2007-10-01','Approved','ksdfh',1);
...
insert  into `cabmaster`(`CabID`,`CabRegNo`,`DriverCode`,`TravelsName`,`ActiveStatus`) values ('CAB1','ewr3432','dgfdg','dfgdfg',NULL),('CAB2','sdf','fdgfd','dfgfdg',NULL),('CAB3','sf3243','dfgdf','dfgdfg',NULL),('CAB4','AXC2232','raju','raj travells',NULL),('CAB5','ABCD1981','Raju','Raj Travels',NULL),('CAB6','AP 12 3345','Raju','Raghu Travels',NULL);
...
insert  into `cabrequest`(`RequestID`,`EmpNo`,`EmpMailID`,`DateOfRequest`,`Time`,`From`,`To`,`CabID`,`ApproversMailID`,`Status`) values ('RC1','55555','kals_kals@xyz.com','2000-01-11','10:20','Campus','Central Railway Station','CAB6','Ram_ram@xyz.com','Approved'),('RC10','11','sdfsdf@sdf.com','2008-04-02','11:11','asdf','sdf','','harish@ghi.com','Declined'),('RC11','111','asdf@asdf.com','2008-04-18','11:11','sdf','sdf','','harish@ghi.com','Approved'),('RC2','88888','dfgfd@xyz.com','2007-01-12','22:10','Campus','Mehadipatnam','CAB3','dfgfd@xyz.com','Approved'),('RC5','88989','asedf@xyz.com','2000-01-19','11:09','asdef','asddff','','asedf@xyz.com','Open'),('RC7','2222','kalyan@xyz.com','2007-10-15','22:00','Campus','Miyapur','CAB4','harish@ghi.com','Approved'),('RC8','6666','kalyan@ghi.com','2000-01-27','22:30','Campus','Mehdipatnam','CAB5','harish@ghi.com','Approved'),('RC9','1','kalyan@gmail.com','2008-04-30','10:10','abc','def','','harish@ghi.com','Approved');
...
insert  into `login`(`userid`,`password`,`auth`) values ('admin','admin',0),('approver','approver',1),('transport','transport',2),('user','user',3);
