...
<%
	...
	ResultSet rs=null;
	Statement stmt=null;
	String Condition = "EmpName";
	String[] ConValues = new String[2000];
	int ConCount=0,i=0;
	String Query1="";
%>
<FORM Name='DelForm' METHOD=POST ACTION="DelEmployee.jsp">
			<CENTER><B><FONT face="verdana"> Select a record to delete from database </FONT></B></CENTER><BR><BR>
   <center>
   <TABLE BORDER="0" CELLSPACING="2"  CELLPADDING="2" >
	<TR class=row_title ALIGN="center"> <TH COLSPAN="2"> Delete Employee</TH>
		<TR class=row_even>
...
<%
	try{
			...
			if(Condition.trim().equalsIgnoreCase("undefined")){
				...
				Query1 = "Select * from employeemaster";
			}
			else{
				System.out.println("in else");
				Query1 = "Select "+Condition+" from employeemaster";
			}
			String str="";
