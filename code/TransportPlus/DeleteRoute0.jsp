...
function fnShowDetails()
			{
				...
				if (RouteID=='')
				{
					...
					var URL = "ShowRoutes01.jsp?RouteID="+RouteID;
...
<%
	...
	String Query1="";
%>
<FORM Name='DelForm' METHOD=POST ACTION="DeleteRoute1.jsp" onsubmit="return validate()">
		 <center>
   <TABLE BORDER="0" CELLSPACING="2"  CELLPADDING="2" >
	<TR class=row_title ALIGN="center"> <TH COLSPAN="2"> Cancel Route</TH>
		<TR class=row_even>
