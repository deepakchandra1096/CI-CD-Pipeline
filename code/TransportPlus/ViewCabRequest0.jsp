...
%>	
<H2 align =center>View CabRequest</H2>

  <FORM NAME="ViewForm" onSubmit="return check()" action="ViewCabRequests.jsp">
   <CENTER>

   <TABLE BORDER="0" CELLSPACING="2"  CELLPADDING="2" >
	   <TR class=row_title  ALIGN="center">
	   <TH COLSPAN="2">View CabRequest </TH>
	   </TR>
	   <TR class=row_even >
