...
<h2 align=center>View Categories</h2>
...
<%
	...
	try{
			...
			String Query = "Select * from categorymaster order by `CategoryID`";
			rs = stmt.executeQuery(Query);
			%>
						<table class=notebook align=center>
							<tr class=row_title>
							<th class=row_title>CategoryID</th>
							<th class=row_title>CategoryCode</th>
							<th class=row_title>Amount</th>
