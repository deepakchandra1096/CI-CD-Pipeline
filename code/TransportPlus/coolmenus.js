...
oCMenu.offlineUrl="file:///C:\Program Files\Apache Group\Tomcat 4.1\webapps\TransportPortal" //Value: "path_to_menu_file_offline/"
...
*/
//Home
oCMenu.makeMenu('top','','<b>&nbsp;Home</b>','mynewmenu.jsp','Frame3',93,27,"Images/Home01.jpg","Images/Home02.jpg")

//TransportCategories
oCMenu.makeMenu('top1','','<b>&nbsp;TransportCategories</b>','','',146,27,"Images/TransportCategories1.jpg","Images/TransportCategories2.jpg")//,0,0,"","",'red','silver')
    oCMenu.makeMenu('sub10','top1','&nbsp;NewCategory','AddNewCategory0.jsp','Frame3',146,27,"Images/AddNewCategory01.jpg","Images/AddNewCategory02.jpg")
    oCMenu.makeMenu('sub11','top1','&nbsp;ViewCategories','ViewCategories.jsp','Frame3',146,27,"Images/ViewCategory01.jpg","Images/ViewCategory02.jpg")
    oCMenu.makeMenu('sub12','top1','&nbsp;DeleteCategory','DeleteCategory0.jsp','Frame3',146,27,"Images/CancelCategory01.jpg","Images/CancelCategory02.jpg")

//Vehicles
	oCMenu.makeMenu('top2','','<b>&nbsp;Vehicles</b>','','',120,27,"Images/Vehicles01.jpg","Images/Vehicle02.jpg")//,0,0,"","",'red','silver')
	oCMenu.makeMenu('sub20','top2','&nbsp;AddNew','AddNewVehicle0.jsp','Frame3',120,27,"Images/AddNew01.jpg","Images/AddNew02.jpg")
    oCMenu.makeMenu('sub21','top2','&nbsp;ViewVehicles','ViewBuses.jsp','Frame3',120,27,"Images/View01.jpg","Images/View02.jpg")

//Routes
oCMenu.makeMenu('top3','','<b>&nbsp;Routes</b>','','',93,27,"Images/Routes001.jpg","Images/Routes002.jpg")//,0,0,"","",'red','silver')
	oCMenu.makeMenu('sub30','top3','&nbsp;AddRoutes','AddNewRoute0.jsp','Frame3',120,27,"Images/AddNew01.jpg","Images/AddNew02.jpg")
    oCMenu.makeMenu('sub31','top3','&nbsp;ViewRoutes','ViewRoutes.jsp','Frame3',120,27,"Images/View01.jpg","Images/View02.jpg")
	oCMenu.makeMenu('sub32','top3','&nbsp;CancelRoutes','DeleteRoute0.jsp','Frame3',120,27,"Images/Cancel01.jpg","Images/Cancel02.jpg")

// BusRequest
oCMenu.makeMenu('top4','','<b>&nbsp;BusRequest</b>','','',120,27,"Images/BusRequest01.jpg","Images/BusRequest02.jpg")//,0,0,"","",'red','silver')
	oCMenu.makeMenu('sub40','top4','&nbsp;AddBusRequest','AddBusRequest0.jsp','Frame3',120,27,"Images/AddNew01.jpg","Images/AddNew02.jpg")
    oCMenu.makeMenu('sub41','top4','&nbsp;ViewBusRequest','ViewBusRequest0.jsp','Frame3',120,27,"Images/View01.jpg","Images/View02.jpg")
    oCMenu.makeMenu('sub42','top4','&nbsp;CancelBusRequest','DelBusRequest.jsp','Frame3',120,27,"Images/Cancel01.jpg","Images/Cancel02.jpg")

//CabRequest
oCMenu.makeMenu('top5','','<b>&nbsp;CabRequest</b>','','',120,27,"Images/CabRequest01.jpg","Images/CabRequest02.jpg")//,0,0,"","",'red','silver')
	oCMenu.makeMenu('sub50','top5','&nbsp;AddCabRequest','AddNewCabRequest0.jsp','Frame3',120,27,"Images/AddNew01.jpg","Images/AddNew02.jpg")
    oCMenu.makeMenu('sub51','top5','&nbsp;ViewRequests','ViewCabRequest0.jsp','Frame3',120,27,"Images/View01.jpg","Images/View02.jpg")
    oCMenu.makeMenu('sub52','top5','&nbsp;AssignCab','AssignCabRequests.jsp','Frame3',120,27,"Images/Assign01.jpg","Images/Assign02.jpg")
	oCMenu.makeMenu('sub53','top5','&nbsp;CancelRequests','DelCabRequest.jsp','Frame3',120,27,"Images/Cancel01.jpg","Images/Cancel02.jpg")
//Approvals
oCMenu.makeMenu('top6','','<b>&nbsp;Approvals</b>','','',93,27,"Images/Approvals001.jpg","Images/Approvals002.jpg")//,0,0,"","",'red','silver')
	oCMenu.makeMenu('sub60','top6','&nbsp;ApproveBusRequest','ApproveBusRequests0.jsp','Frame3',120,27,"Images/BusApproval01.jpg","Images/BusApproval02.jpg")
    oCMenu.makeMenu('sub61','top6','&nbsp;ApproveCabRequest','ApproveCabRequest0.jsp','Frame3',120,27,"Images/CabApproval01.jpg","Images/CabApproval02.jpg")
 
//Reports
oCMenu.makeMenu('top7','','&nbsp;Reports','','',120,27,"Images/Report01.jpg","Images/Reports02.jpg")
	
	oCMenu.makeMenu('sub70','top7','&nbsp;Routes&nbsp;','GenericAvsBReport.jsp?TableName=busrequest&VerCategory=Status&HorCategory=StartDate&Title=Bus requests Detailed Report','Frame3',146,27,"Images/BusRequestDetails1.jpg","Images/BusRequestDetails2.jpg")
	oCMenu.makeMenu('sub71','top7','&nbsp;Categories&nbsp;','GenericReport.jsp?Category=RouteCode&Title=Bus Occupancy  Report&TableName=busrequest&Condition=ActiveStatus=1','Frame3',146,27,"Images/BusOccupancyReport1.jpg","Images/BusOccupancyReport2.jpg")
	oCMenu.makeMenu('sub72','top7','&nbsp;Requests&nbsp;','GenericAvsBReport.jsp?TableName=cabrequest&VerCategory=Status&HorCategory=EmpNo&Title=Employee wise cab requests  report','Frame3',146,27,"Images/CabRequestDetails1.jpg","Images/CabRequestDetails2.jpg")
	//oCMenu.makeMenu('sub73','top7','&nbsp;Approvals&nbsp;','GenericReport.jsp?Category=EmpNo&Title=Employee wise Cab Requests Report&TableName=cabrequest','Frame3',146,27,"Images/CabRequestStatus1.jpg","Images/CabRequestStatus2.jpg")
	oCMenu.makeMenu('sub73','top7','&nbsp;Approvals&nbsp;','GenericReport.jsp?Category=Status&Title=Cab Requests Status Report&TableName=cabrequest','Frame3',146,27,"Images/CabRequestStatus1.jpg","Images/CabRequestStatus2.jpg")
	
//Logout
oCMenu.makeMenu('top8','','<b>&nbsp;Logout</b>','Logout.jsp','Frame3',93,27,"Images/Logout01.jpg","Images/Logout02.jpg")
